...
questions = []
#q-count and q index are to keep track of total
# no of question and current question 
question_count = 0
question_index = 0
#move_ip(moves the rectange to respective place. IP means in place)
...
def draw():
    ...
    screen.draw.textbox(
        # question[0] is the first item in question list which we got from read nextquestion
...
def read_question_file():
    ...
    #each line in question file in one item
...
def read_next_question():
    ...
    #picking the first item in question list and seperating the item with ","
